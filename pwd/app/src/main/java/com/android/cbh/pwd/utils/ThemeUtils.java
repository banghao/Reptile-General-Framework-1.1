package com.android.cbh.pwd.utils;
...
public class ThemeUtils {
    ...
    public static Theme getCurrentTheme(Context context){
        int value = (int) com.android.yzd.memo.utils.SPUtils.get(context, context.getResources().getString(R.string.change_theme_key), 1);
